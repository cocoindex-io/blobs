...
</style></head><body><div class="eyebrow"><span class="dot"></span>CocoIndex &middot; Manuals extraction flow</div><div class="col">
{node("logic","Source","localfs.walk_dir","manuals · *.pdf")}{ARROW}
<div class="comp"><div class="comp-cap">Processing Component &middot; <span class="reg">mount_each &rarr; process_file (per manual, memoized)</span></div><div class="col">
{node("logic","Transform · docling · GPU runner","pdf_to_markdown","PDF bytes → Markdown")}{ARROW}
{node("logic","Transform · LLM extract","instructor + LiteLLM","ModuleInfo · title · classes · methods · args")}{ARROW}
{node("target","Target state · one per manual","declare_row → ModuleRecord","filename · title · num_classes · num_methods · module_info")}</div></div>{ARROW}
{node("logic","Target","Postgres","modules_info table")}

...
def flow_svg():
    ...
    s.append(f'<text x="82" y="{y+11}" dominant-baseline="central" font-family="{MONO}" '
             ...
             f'COCOINDEX · PDF EMBEDDING FLOW</text>')
    y += 30 + 28
    ...
    iy = y + COMP_PAD_T
    s.append(fnode(CX, iy, INNER_W, "logic", "Transform · docling · GPU runner",
                   "pdf_to_markdown",
                   "PDF bytes → Markdown · coco.fn.as_async(runner=GPU)"))
    iy += FNODE_H

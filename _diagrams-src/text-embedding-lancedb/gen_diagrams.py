...
def flow_svg():
    ...
    s.append(f'<text x="82" y="{y+11}" dominant-baseline="central" font-family="{MONO}" '
             ...
             f'COCOINDEX · TEXT EMBEDDING FLOW · LANCEDB</text>')
    y += 30 + 28
    ...
    s.append(fnode(CX, y, NODE_W, "logic", "Target", "LanceDB · embedded",
                   "doc_embeddings table · ./lancedb_data · no server", mono=False))
    y += FNODE_H
